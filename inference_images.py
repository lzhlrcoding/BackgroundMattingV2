...
parser.add_argument('--model-checkpoint', type=str, required=False, default='pytorch_resnet50.pth')
...
if __name__ == '__main__':
    handle("content/img/img.png", "content/bgr/img.png", "content/output/output.png")